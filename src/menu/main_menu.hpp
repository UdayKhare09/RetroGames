...
public:
    ...
    void update(core::InputManager& input) {
        bool up_pressed = input.isUpPressed();
        bool down_pressed = input.isDownPressed();
    ...
    void render(core::Renderer& renderer) const {
        ...
        for (size_t i = 0; i < items_.size(); ++i) {
            ...
            if (i == selected_index_) {
                // Selected item text in bright color (no background)
